...
<!-- Please read the https://github.com/linuxserver/docker-prowlarr/blob/nightly-alpine/.github/CONTRIBUTING.md -->
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/prowlarr`
...
* Update the image: `docker pull lscr.io/linuxserver/prowlarr`
...
* **28.12.21:** - Rebase develop branch to Alpine.
